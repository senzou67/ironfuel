const ShopPage = {
    ...
    _svgIcons: {
        ...
        title_warrior: `<svg width="28" height="28" viewBox="0 0 32 32"><defs><linearGradient id="gTW" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#C62828"/><stop offset="100%" stop-color="#B71C1C"/></linearGradient></defs><path d="M16 4l-6 8h4v12h4V12h4z" fill="url(#gTW)"/><path d="M10 12l-4 4M22 12l4 4" stroke="#C62828" stroke-width="1.5" stroke-linecap="round"/></svg>`,
    ...
    preview(itemId) {
        ...
        if (item.type === 'title') {
            const titleStyles = {
                ...
                title_warrior: 'color:#C62828;text-shadow:0 0 6px rgba(230,74,25,0.4);font-size:18px;font-weight:700;letter-spacing:1px',
