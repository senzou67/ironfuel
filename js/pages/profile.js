    ...
    render() {
        ...
        content.innerHTML = `
            <div class="profile-container fade-in">
                <div class="profile-avatar creature-display${Storage.getEquippedItems().some(i => i.type === 'aura') ? ' has-svg-aura' : ''}" data-type="${(Creature.getData().type || 'fire')}" style="display:flex;justify-content:center">
                    ${Avatar.buildSVG(90)}
                </div>
